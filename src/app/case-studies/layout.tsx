...
export const metadata: Metadata = generateMetadata({
  ...
  description: "Explore success stories from startups that secured funding through RaiseSignal. See how founders raised $50M+ across different industries with our verified investor network.",
  keywords: [
    ...commonKeywords,
